...
export default function Statistique() {
  ...
  return (
    ...
    >
            ...
            <div className="container">
              <div className="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0">
                <div className="col-lg-4 text-center text-lg-start">
                  ...
                  <p className="lead fs-lg mb-0 text-secondary pe-xxl-10">
      ...
      <div className="container">
        <div className="grid mb-8 mb-lg-0">
          <div className="row isotope gy-14 mt-n18">
            <div className="item col-md-6 col-xl-3">
              <div className="card shadow-lg card-border-bottom border-soft-primary">
                <div className="card-body">
                  <blockquote className="icon mb-0">
                    <p>{findElementByKey('review_text1')}</p>
                    <div className="blockquote-details">
                      <div className="info ps-0">
                        <h5 className="mb-1">
                          {findElementByKey('review_name1')}
                        </h5>
                        <p className="mb-0">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="item col-md-6 col-xl-3">
              <div className="card shadow-lg card-border-bottom border-soft-primary">
                <div className="card-body">
                  <blockquote className="icon mb-0">
                    <p>“{findElementByKey('review_text2')}</p>
                    <div className="blockquote-details">
                      <div className="info ps-0">
                        <h5 className="mb-1">
                          {findElementByKey('review_name2')}
                        </h5>
                        <p className="mb-0">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="item col-md-6 col-xl-3">
              <div className="card shadow-lg card-border-bottom border-soft-primary">
                <div className="card-body">
                  <blockquote className="icon mb-0">
                    <p>{findElementByKey('review_text3')}</p>
                    <div className="blockquote-details">
                      <div className="info ps-0">
                        <h5 className="mb-1">
                          {findElementByKey('review_name3')}
                        </h5>
                        <p className="mb-0">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="item col-md-6 col-xl-3">
              <div className="card shadow-lg card-border-bottom border-soft-primary">
                <div className="card-body">
                  <blockquote className="icon mb-0">
                    <p>{findElementByKey('review_text4')}</p>
                    <div className="blockquote-details">
                      <div className="info ps-0">
                        <h5 className="mb-1">
                          {findElementByKey('review_name4')}
                        </h5>
                        <p className="mb-0">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
