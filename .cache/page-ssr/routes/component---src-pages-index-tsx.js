...
const DatasContextProvider = ({
  ...
  const {
    0: currentLanguage,
    1: UpdateLanguage
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(localStorage.getItem('defaultLanguage') || navigator.language.slice(0, 2).toUpperCase());
...
"use strict";
module.exports = JSON.parse('{"data":{"allStrapiBwImage":{"nodes":[{"model":"Prado TXL","price":50000,"id":"e2296672-74d7-5e7e-a984-2e83fafa5794","color":"noire","brand":"Toyota","localizations":{"data":[{"attributes":{"color":"black"}}]},"car_image":{"url":"/uploads/Prado_cecf5312e7.png"},"key":"PradoTXL1"},{"model":"Avensis II","price":25000,"id":"b2cffc9f-09bc-53a2-8150-1a2e748be23e","color":"bleue","brand":"Toyota","localizations":{"data":[{"attributes":{"color":"blue"}}]},"car_image":{"url":"/uploads/Avensis_f0816f6c02.png"},"key":"AvensisII"}]}}}');
